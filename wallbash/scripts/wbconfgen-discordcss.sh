...
if [[ -n "$rarray" ]]; then
  ...
  sed -i "s|--accentcolor: .*;|--accentcolor: ${wallbash[wallbash_1xa6]};|g" "$subTarget"
  sed -i "s|--accentcolor2: .*;|--accentcolor2: ${wallbash[wallbash_pry2]};|g" "$subTarget"
  sed -i "s|--linkcolor: .*;|--linkcolor: ${wallbash[wallbash_1xa6]};|g" "$subTarget"
  sed -i "s|--mentioncolor: .*;|--mentioncolor: ${wallbash[wallbash_1xa5]};|g" "$subTarget"
  sed -i "s|--textbrightest: .*;|--textbrightest: ${wallbash[wallbash_txt1]};|g" "$subTarget"
  sed -i "s|--textbrighter: .*;|--textbrighter: ${wallbash[wallbash_txt2]};|g" "$subTarget"
  sed -i "s|--textbright: .*;|--textbright: ${wallbash[wallbash_1xa9]};|g" "$subTarget"
  sed -i "s|--textdark: .*;|--textdark: ${wallbash[wallbash_3xa9]};|g" "$subTarget"
  sed -i "s|--textdarker: .*;|--textdarker: ${wallbash[wallbash_3xa5]};|g" "$subTarget"
  sed -i "s|--textdarkest: .*;|--textdarkest: ${wallbash[wallbash_3xa1]};|g" "$subTarget"
  sed -i "s|--backgroundaccent: .*;|--backgroundaccent: ${wallbash[wallbash_1xa5]};|g" "$subTarget"
  sed -i "s|--backgroundprimary: .*;|--backgroundprimary: ${wallbash[wallbash_2xa1]};|g" "$subTarget"
  sed -i "s|--backgroundsecondary: .*;|--backgroundsecondary: ${wallbash[wallbash_pry1]};|g" "$subTarget"
